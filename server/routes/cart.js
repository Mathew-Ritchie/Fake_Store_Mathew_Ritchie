...
import {
  ...
  clearCart,
} from "../controllers/cartController.js"; // Import the controllers
...
router.delete("/:itemId", authenticateToken, removeItemUnitFromCart); // DELETE one item unit
router.delete("/", authenticateToken, clearCart); // DELETE all items (clear cart)
