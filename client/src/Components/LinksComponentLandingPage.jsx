...
export default function LinksComponentLandingPage() {
  return (
    <div className="landing-page-background-div min-h-screen flex flex-col items-center gap-2 w-full bg-gray-100 pb-5">
      {/* Link for all items */}
      <div className="group px-3 w-full flex justify-center items-center pb-2">
        <Link to="/main" className="w-full h-[100px]">
          ...
          >
            <button className="bg-gray-700/90 text-gray-100 group-hover:bg-black/90 font-bold text-2xl rounded-r-2xl w-[200px] px-5 py-2.5">
              All Items
            </button>
          </div>
        </Link>
      ...
      <div className="flex flex-col sm:flex-row justify-center items-center gap-2 w-full px-3">
        ...
        <Link to="/main?category=women%27s+clothing" className="h-[400px] w-full sm:w-4/6">
          <div
            ...
            className="group landing-page-image-div w-full h-full bg-cover bg-center "
          >
            <button className="bg-gray-700/70 group-hover:bg-black/90 text-gray-100 font-bold text-2xl rounded-r-2xl w-[200px] mt-60 px-5 py-2.5">
              Women
            </button>
          </div>
        </Link>
      ...
      <div className="flex justify-center flex-col sm:flex-row items-center gap-2 w-full px-3">
        ...
        <Link to="/main?category=electronics" className="w-full sm:w-4/6 h-[400px]">
          <div
            ...
            className="group landing-page-image-div h-full w-full bg-cover bg-center"
          >
            <button className="bg-gray-700/70 group-hover:bg-black/90 text-gray-100 font-bold text-2xl rounded-r-2xl w-[200px] mt-60 px-5 py-2.5">
              Tech
            </button>
